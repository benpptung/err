...
/**
 * Create an enriched Error with debug info.
 * - er.msgs: string[]  // pipeline 途中逐層累積訊息
 * - er.original: object // 原始除錯資訊（舊保留，新補上）
 * @param {string} msg
...
/**
 * Wrap/enhance an existing error.
 * 保留現有 err.original，並以「舊保留，新補上」為準則：
